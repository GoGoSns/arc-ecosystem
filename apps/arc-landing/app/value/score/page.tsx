...
const TIER_MAP = {
  ...
  gold: { label: 'Gold', color: '#d4af37', icon: '🥇', min: 401 },
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-4xl mx-auto px-6 pt-32 pb-20">
        ...
        <div className="mb-12">
          ...
          <p className="text-[#8a8a9a] text-lg">Calculate your Arc activity rating from local demo data and community activity.</p>
        </div>
        ...
        <HubCard className="mb-12 p-8">
          <form className="flex flex-col gap-4 md:flex-row md:items-end" onSubmit={(event) => { event.preventDefault(); calculateScore(); }}>
            <div className="flex-1">
              <label className="mb-2 block font-mono text-[10px] uppercase tracking-[0.28em] text-[#555566]" htmlFor="wallet-address">
                Wallet Address
              </label>
              <input
                id="wallet-address"
        ...
        {loading && (
          <div className="space-y-4">
            ...
            <p className="text-center font-mono text-xs uppercase tracking-[0.28em] text-[#555566]">
        ...
        {!loading && !result && !error ? (
          <div className="mb-12 rounded-3xl border border-dashed border-white/10 bg-white/[0.01] p-8 text-center">
            <p className="font-mono text-xs uppercase tracking-[0.28em] text-[#d4af37]">Demo Preview</p>
            <p className="mt-4 text-[#8a8a9a]">Enter any wallet address to generate a local score snapshot.</p>
          </div>
        ) : null}
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="relative rounded-3xl p-12 bg-white/[0.02] border border-white/[0.05] overflow-hidden text-center">
              ...
              <div className="relative z-10">
                <div className="text-sm font-mono text-[#555566] mb-4 uppercase tracking-[0.3em]">Overall Score</div>
                    ...
                    return (
                      <div key={key}>
                        <div className="flex justify-between text-xs mb-2 uppercase tracking-widest font-bold">
                          <span className="text-[#555566]">{labels[key]}</span>
                ...
                <div className="space-y-4">
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/5 flex gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-[#555566]">Process $500 more in USDC transfers to gain 50 points.</div>
                    </div>
                  </div>
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/5 flex gap-4">
                    <div className="w-10 h-10 rounded-full bg-[#d4af37]/20 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-[#555566]">Create a Tip Jar or post a Bounty to increase App usage score.</div>
                    </div>
                  </div>
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/5 flex gap-4">
                    <div className="w-10 h-10 rounded-full bg-[#d4af37]/20 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-[#555566]">Contribute to discussions to boost your Community score.</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Share Section */}
            <div className="rounded-3xl p-10 bg-[#d4af37]/5 border border-[#d4af37]/20 flex flex-col md:flex-row items-center justify-between gap-8">
              <div>
                <h3 className="text-2xl font-black mb-2">PROUD OF YOUR SCORE?</h3>
                <p className="text-[#8a8a9a]">Share your achievement with the Arc community.</p>
              </div>
