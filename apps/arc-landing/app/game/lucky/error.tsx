...
export default function LuckyError({ error: _error, reset }: { error: Error; reset: () => void }) {
  useEffect(() => {
  ...
  return (
    <section className="section pt-24 sm:pt-28">
      <div className="mx-auto max-w-3xl">
        <HubEmptyState
          icon={AlertTriangle}
          title="Lucky hub failed to load"
          description="An unexpected error occurred while loading the lucky pack route."
          tone="error"
        >
