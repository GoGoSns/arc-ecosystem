...
function MetricTile({
  ...
  return (
    <div className="rounded-2xl border border-[#2a2a2a] bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(0,0,0,0.24))] px-4 py-3 transition-colors duration-200 hover:border-[#c9a84c]/30">
    ...
    <HubCard as="section" className={`p-6 sm:p-8 ${className}`.trim()}>
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0">
          <HubBadge className="border-[#c9a84c]/25 bg-[#c9a84c]/10 text-[#f4dc9f]">Progress</HubBadge>
        ...
        <div className="flex shrink-0 flex-col items-end gap-2 text-right">
          ...
          <div className="text-[clamp(2rem,3.6vw,3rem)] font-black leading-none text-[#f4dc9f]">LV {snapshot.level}</div>
        </div>
      </div>
      ...
      <div className="mt-5 rounded-[1.35rem] border border-[#2a2a2a] bg-[linear-gradient(135deg,rgba(201,168,76,0.08),rgba(48,209,88,0.03)),rgba(255,255,255,0.02)] px-4 py-4">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-3">
          <div className="rounded-2xl border border-[#2a2a2a] bg-black/30 px-4 py-3">
            <div className="text-[10px] font-mono uppercase tracking-[0.26em] text-[#8a8a8a]">Active challenges</div>
            <div className="mt-2 text-lg font-black text-white">{snapshot.activeChallenges}</div>
          </div>
          <div className="rounded-2xl border border-[#2a2a2a] bg-black/30 px-4 py-3">
            <div className="text-[10px] font-mono uppercase tracking-[0.26em] text-[#8a8a8a]">Open lucky packs</div>
            <div className="mt-2 text-lg font-black text-white">{snapshot.openLuckyPacks}</div>
          </div>
          <div className="rounded-2xl border border-[#2a2a2a] bg-black/30 px-4 py-3">
            <div className="text-[10px] font-mono uppercase tracking-[0.26em] text-[#8a8a8a]">Completed</div>
        ...
        <div className="mt-4 rounded-2xl border border-[#2a2a2a] bg-black/30 px-4 py-4">
          <div className="text-[10px] font-mono uppercase tracking-[0.26em] text-[#8a8a8a]">Recent momentum</div>
