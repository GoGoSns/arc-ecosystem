...
export const metadata: Metadata = {
  title: "Arc Play — Web3 Gaming on Arc Network",
  description: "Track your portfolio, predict outcomes, win raffles, play mini-games, and launch tokens. All powered by USDC on Arc Testnet.",
